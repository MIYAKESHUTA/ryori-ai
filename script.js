const tree = {
  ...
  steps: [
    "1. 豚ロース肉に塩・こしょうをふり、小麦粉→卵→パン粉の順に衣をつける。",
    "2. 170〜180℃の油できつね色になるまで両面を揚げる（1枚あたり3分×2）。",
    "3. 鍋にだし・醤油・みりん・砂糖・玉ねぎを入れて中火で3分ほど煮る。",
    "4. 揚げたとんかつを1cm幅に切って玉ねぎの上にのせ、溶き卵を回しかける。",
    "5. 卵が半熟になったら火を止め、ご飯にのせて三つ葉を飾って完成。"
  ],
  tips: [
    "卵は2回に分けてかけるとふわとろ食感になる。",
    "だし汁がなければ、白だし＋水や顆粒だし＋水でも代用可。",
    "とんかつは揚げたてでもスーパーのお惣菜でもOK。"
  ]
};
